...
& liouvillian,exact_solution, factorial,correlations, integrate, test_integrate,wigner
  ...
  real(dp) ::  gamma, Omega, start, finish, t_start = 10, ss,W,x,p,tau,time
  ...
  nruns = 20000
   ...
   call wigner(nruns,gamma, sigma_minus, dt ,'test', rhovec_zero, H,tau,time,x,p,W)
