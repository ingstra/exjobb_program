...
rho_real = np.loadtxt('2channels/rho_re_Omega0_5_T5.dat')
rho_im = np.loadtxt('2channels/rho_im_Omega0_5_T5.dat')
...
wcmap = w_cmap(W,shift=-5e-4)

plt1 = ax1.contourf(x, p, W, 100, cmap=wcmap)
cb1 = fig.colorbar(plt1, ax=ax1)

#plt.savefig('../figures/2channels_T10_Omega2_2.pdf',figsize=(10,10))
